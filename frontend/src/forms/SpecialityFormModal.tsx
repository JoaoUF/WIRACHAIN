...
interface SpecialityFormModalProps {
  open: boolean;
  onCancel: () => void;
  onFinish: (values: { name: string; description: string }) => void;
  loading?: boolean;
  editingSpeciality?: SpecialityBasic | null;
  form: FormInstance;
}

export function SpecialityFormModal({
  open,
  onCancel,
  onFinish,
  loading,
      ...
      >
        ...
        <Form.Item className="mb-0 mt-6">
          <Space className="w-full flex justify-end">
            ...
            >
              {editingSpeciality ? "Update" : "Add"} Speciality
            </Button>
          </Space>
        </Form.Item>
      </Form>
